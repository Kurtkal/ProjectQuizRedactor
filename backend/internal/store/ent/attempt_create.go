...
func (_c *AttemptCreate) SetUserID(id int) *AttemptCreate {
...
func (_c *AttemptCreate) SetQuizID(id int) *AttemptCreate {
...
func (_c *AttemptCreate) AddAttemptAnswerIDs(ids ...int) *AttemptCreate {
	_c.mutation.AddAttemptAnswerIDs(ids...)
	return _c
}

// AddAttemptAnswers adds the "attempt_answers" edges to the Attempt_answers entity.
func (_c *AttemptCreate) AddAttemptAnswers(v ...*Attempt_answers) *AttemptCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *AttemptCreate) check() error {
	...
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "Attempt.user"`)}
	}
	if len(_c.mutation.QuizIDs()) == 0 {
		return &ValidationError{Name: "quiz", err: errors.New(`ent: missing required edge "Attempt.quiz"`)}
	}
	return nil
}
