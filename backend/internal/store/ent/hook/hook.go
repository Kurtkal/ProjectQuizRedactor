...
// The AnswersFunc type is an adapter to allow the use of ordinary
// function as Answers mutator.
type AnswersFunc func(context.Context, *ent.AnswersMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AnswersFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AnswersMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AnswersMutation", m)
}
...
// The Attempt_answersFunc type is an adapter to allow the use of ordinary
// function as Attempt_answers mutator.
type Attempt_answersFunc func(context.Context, *ent.AttemptAnswersMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Attempt_answersFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AttemptAnswersMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AttemptAnswersMutation", m)
}
