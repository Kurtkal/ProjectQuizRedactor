...
// PassThresholdIsNil applies the IsNil predicate on the "pass_threshold" field.
func PassThresholdIsNil() predicate.Quiz {
	return predicate.Quiz(sql.FieldIsNull(FieldPassThreshold))
}

// PassThresholdNotNil applies the NotNil predicate on the "pass_threshold" field.
func PassThresholdNotNil() predicate.Quiz {
	return predicate.Quiz(sql.FieldNotNull(FieldPassThreshold))
}
...
func HasCreator() predicate.Quiz {
...
func HasCreatorWith(preds ...predicate.User) predicate.Quiz {
	return predicate.Quiz(func(s *sql.Selector) {
		step := newCreatorStep()
...
func HasQuestionsWith(preds ...predicate.Questions) predicate.Quiz {
	return predicate.Quiz(func(s *sql.Selector) {
