...
var (
	...
	AnswersColumns = []*schema.Column{
		...
		{Name: "questions_answers", Type: field.TypeInt},
	}
	...
	AnswersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "answers_order_index_questions_answers",
				Unique:  true,
				Columns: []*schema.Column{AnswersColumns[3], AnswersColumns[4]},
			},
		},
	}
	...
	AttemptsColumns = []*schema.Column{
		...
		{Name: "user_attempts", Type: field.TypeInt},
	}
	...
	AttemptsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "attempt_created_at_user_attempts_quiz_attempts",
				Unique:  false,
				Columns: []*schema.Column{AttemptsColumns[3], AttemptsColumns[5], AttemptsColumns[4]},
			},
		},
	}
	...
	AttemptAnswersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "attempt_attempt_answers", Type: field.TypeInt},
		{Name: "attempt_answers_question", Type: field.TypeInt},
		{Name: "attempt_answers_answer", Type: field.TypeInt},
	}
	...
	AttemptAnswersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "attempt_answers_questions_question",
				Columns:    []*schema.Column{AttemptAnswersColumns[2]},
				RefColumns: []*schema.Column{QuestionsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "attempt_answers_answers_answer",
		...
		Indexes: []*schema.Index{
			{
				Name:    "attempt_answers_attempt_attempt_answers_attempt_answers_question",
				Unique:  true,
				Columns: []*schema.Column{AttemptAnswersColumns[1], AttemptAnswersColumns[2]},
			},
		},
	}
	...
	QuestionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "questions_order_index",
				Unique:  false,
				Columns: []*schema.Column{QuestionsColumns[2]},
			},
			{
				Name:    "questions_order_index_quiz_questions",
				Unique:  true,
				Columns: []*schema.Column{QuestionsColumns[2], QuestionsColumns[3]},
			},
		},
	}
	...
	QuizsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "quiz_is_published",
				Unique:  false,
				Columns: []*schema.Column{QuizsColumns[2]},
			},
		},
	}
...
func init() {
	...
	AttemptAnswersTable.ForeignKeys[0].RefTable = AttemptsTable
	AttemptAnswersTable.ForeignKeys[1].RefTable = QuestionsTable
	AttemptAnswersTable.ForeignKeys[2].RefTable = AnswersTable
